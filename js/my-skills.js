...
function loadSkillCircleContainer(skillCircleContainer) {
    const skillCircleNumber = $("#skill-circle-container-template").children()
                                                                   .length - 1;
...
function getSkillCircleContainer(skillLevel, skillCircleNumber) {
    const skillCircleContainerClone = $("#skill-circle-container-template").clone();
...
function getSkillLevelDescription(skillLevel) {
    const skillLevelDescriptionContainer = $("#skill-level-description-container ul");
    const skillLevelDescription = skillLevelDescriptionContainer.children()
                                                                .eq(skillLevel)
                                                                .text();
